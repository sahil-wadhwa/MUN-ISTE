        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-black mb-8 text-sm sm:text-base">
              Thank you for registering for the CUMUN Conference 2025 (October 15th - 17th 2025), a part of Technicia'25 - ISTE Zonal Convention cum Technical Fest. We'll connect with you soon
              for further process.
            </p>
            <button
